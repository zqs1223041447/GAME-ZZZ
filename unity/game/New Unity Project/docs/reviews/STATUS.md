...
| S5 Build Identity & Itemization Depth（DIR-1） | **SEEDED / NOT ACTIVATED（仅 seed，不构成开工）** | seed=`docs/reviews/S4R/S4R_S5_SEED.md`；mission=复用 S4 面（3 Skills/7 Supports/6 槽/17 词缀/单一 applicability/确定性工具链/RC 候选）使 build 差异明显化；**4 原子待导演决定（BL-002.A1 建议首批 / BL-021.A1 孔色 / BL-021.A2 多连接 / BL-012.A1 宝石等级品质）**；Capability delta=NONE；全部硬停止与排除清单延续 |
