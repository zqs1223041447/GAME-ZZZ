...
本轮 commit：A=6ad5679（test：failure-safe 审计 Collect→Render→Persist→Assert + 8 契约测试）+ f2673da（docs：M3 复核 PASS + DECISIONS 长期规则 + STATUS 门规修正）/ B=回填本行
