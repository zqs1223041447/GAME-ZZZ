...
| Socket / Link | Partial | RUNTIME.md Support/Socket 节（Weapon 3S→Q、Body 3S→W、Helmet 2S→E、Boots 0S；一条 Link；无孔色；Gloves/Belt=0S 词缀位） | 孔色/多 Link=Unsupported；扩孔需导演授权 |
