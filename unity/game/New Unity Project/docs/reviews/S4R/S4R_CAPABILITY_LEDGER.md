...
| Socket / Link | Partial | RUNTIME.md Support/Socket 节（Weapon 3S→Q、Body 3S→W、Helmet 2S→E、Boots 0S；一条 Link；无孔色；Gloves/Belt 各 1 孔仅展示计数、不映射技能孔位——SupportCapacity 只走 Weapon/Body/Helmet） | **S5 授权跟踪（2026-09-09）**：Multiple Link Groups=**AUTHORIZED NOT IMPLEMENTED**（BL-021.A2 已获导演批准，合同=`docs/reviews/S5/S5_LINK_CONTRACT.md`，Phase 1 起实现）；Socket Color=**显式拒绝（导演，S5）**；Gem Level/Quality=**显式拒绝（导演，S5）**；状态仍 Partial（孔色缺席不变），不晋升 |
